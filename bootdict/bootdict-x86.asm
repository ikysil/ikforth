...
;                ALIGN       16
                ...
                INCLUDE_HEADER_TC
                $INCLUDED   "bootdict/x86-wordlist/wordlist-traverse.asm"
                $INCLUDED   "bootdict/x86-wordlist/wordlist-create.asm"
                ...
                $INCLUDED   "bootdict/x86-wordlist/wordlist-search.asm"
